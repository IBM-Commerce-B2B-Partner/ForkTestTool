...
public class Runner implements Runnable {
	...
	public Runner(int threadNumber, String sourceFile, List<TimingResult> listWithResults, CountDownLatch cdl,
			Runtime rt) {
		super();
	...
	public void original() throws IOException, InterruptedException {
		...
		TimingResult tr = new TimingResult(duration, threadNumber, sourceFile);
